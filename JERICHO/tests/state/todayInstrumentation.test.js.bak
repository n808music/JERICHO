    ...
    const blocks = normalizeBlocks([
      {
        id: 'a',
        practice: 'Body',
        start: iso('2025-12-09', '10:00'),
        end: iso('2025-12-09', '11:00'),
        status: 'planned',
      },
      {
        id: 'b',
        practice: 'Body',
        start: iso('2025-12-09', '12:00'),
        end: iso('2025-12-09', '13:00'),
        status: 'completed',
      },
      {
        id: 'c',
        practice: 'Creation',
        start: iso('2025-12-09', '14:00'),
        end: iso('2025-12-09', '15:30'),
        status: 'completed',
      },
    ]);
    ...
    const blocks = normalizeBlocks([
      {
        id: 'a',
        practice: 'Body',
        start: iso('2025-12-08', '10:00'),
        end: iso('2025-12-08', '11:00'),
        status: 'completed',
      },
      {
        id: 'b',
