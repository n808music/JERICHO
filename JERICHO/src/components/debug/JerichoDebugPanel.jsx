        ...
        <div style={{ marginBottom: 14 }}>
          ...
          {Object.entries(output).map(([k, v]) => (
            <div key={k} style={{ display: "flex", gap: 8, marginBottom: 3 }}>
              ...
              >
                {Array.isArray(v) ? `[${v.join(", ")}]` : v === null ? "null" : v === undefined ? "undefined" : String(v)}
              </span>
            </div>
          ))}
        </div>
  ...
  if (!isOpen) {
    return (
      ...
      >
        ...
        />
        <span style={{ fontFamily: "monospace", fontSize: 10, color: "#555", letterSpacing: 1 }}>
          JERICHO DEBUG
        </span>
      </div>
    );
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <span style={{ fontSize: 10, color: "#666", letterSpacing: 2, fontWeight: 700 }}>
          JERICHO DEBUG
        </span>
      ...
      >
        ...
        <MetricCard
          label="COMMITTED"
          value={latestCommit?.outputSummary?.createdBlockCount ?? "—"}
          accent="#00aaff"
        />
        <MetricCard
          label="SUGGESTIONS"
        ...
        <MetricCard
          label="HORIZON"
          value={latestGenerate?.inputSummary?.horizonDays ?? "—"}
        />
        <MetricCard
          label="VERDICT"
