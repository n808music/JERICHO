...
describe('ZionDashboard start date guard', () => {
  ...
  it('hides draft schedule items before the goal start date and shows them on start day', async () => {
    mockStore = buildStore(
      [
        {
          id: 's-before',
  ...
  it('removes pre-start guard when the draft is within the start window', async () => {
    mockStore = buildStore(
      [
        {
          id: 's-start',
