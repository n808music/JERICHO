...
-
- Exports:
- - MechanismClass type: 'CREATE' | 'PUBLISH' | 'MARKET' | 'LEARN' | 'OPS' |
    'REVIEW'
...
- File: src/core/**tests**/mechanismClass.test.ts (35 tests)
-
- Coverage:
...
- File: src/core/**tests**/autoDeliverables.test.ts (24 tests)
-
- Coverage:
...
- File: src/core/**tests**/autoGeneration.integration.test.ts (37 tests)
-
- Coverage:
...
- - Plan generation: Auto-seed ensures deliverables exist before calling
    generateColdPlan()
- - UI flow: Button → action → auto-seed → proposedBlocks populated
-
- Requirement 2: "Keep manual deliverables editing as override, never
  prerequisite"
-
- ✅ VALIDATED via:
...
- 5.  Titles substituted: "Prepare music for release", "Create release
      materials", etc.
- 6.  Returns: [
...
-
- Result: No manual deliverable entry required. Plan generated
  deterministically. \*/
...
- ✓ src/core/**tests**/mechanismClass.test.ts (200 lines, 35 tests)
- ✓ src/core/**tests**/autoDeliverables.test.ts (270 lines, 24 tests)
- ✓ src/core/**tests**/autoGeneration.integration.test.ts (320 lines, 37 tests)
-
- MODIFIED:
